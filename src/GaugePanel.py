...
class GaugePanel(QWidget):
    def __init__(self, parent = None):
        ...
        # This timer class is used to set the value of the Gauge
    ...
    def drawIndicator(self, p):
        ...
        degRotate = self._startAngle+(360-(self._startAngle-self._endAngle)) / (self._maxValue - self._minValue) * (self._value - self._minValue)
        #画指针
        p.rotate(degRotate)
